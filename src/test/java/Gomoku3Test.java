...
//    }
    ...
    public void validator27(int rot) {
        ...
        try {
            ...
            gomoku.firstMark(CROSS);
            gomoku.size(size);
            Move next = gomoku.nextMove(rotateMoves(moves, rot, size), CROSS);
            Move expected2 = new Move(new Position(5, 8), CROSS);
            System.out.println(next);
            boolean isValid = next.equals(rotate(expected2, rot, size));
...
//    }
    ...
    public void validator28AllRotations() {
        Set<Move> base = Set.of(
                new Move(new Position(5, 1), NOUGHT), new Move(new Position(1, 4), CROSS),
                new Move(new Position(5, 4), NOUGHT), new Move(new Position(2, 5), CROSS),
    ...
    public void validator46AllRotations() throws TheWinnerIsException, ResignException, WrongBoardStateException {
        Set<Move> base = Set.of(
                new Move(new Position(6, 0), Mark.NOUGHT),
                new Move(new Position(1, 1), Mark.CROSS),
                new Move(new Position(6, 1), Mark.NOUGHT),
                new Move(new Position(3, 3), Mark.CROSS),
                new Move(new Position(2, 4), Mark.CROSS),
                new Move(new Position(6, 4), Mark.NOUGHT),
                new Move(new Position(1, 5), Mark.CROSS),
                new Move(new Position(6, 5), Mark.NOUGHT)
        );
        Move exp0 = new Move(new Position(0, 6), CROSS);
...
//            g.periodicBoundaryConditionsInUse();
    ...
    public void validator53AllRotations() throws TheWinnerIsException, ResignException, WrongBoardStateException {
        Set<Move> base = Set.of(
                ...
                new Move(new Position(1, 1), Mark.CROSS),
                new Move(new Position(6, 1), Mark.NOUGHT),
                new Move(new Position(1, 2), Mark.CROSS),
                new Move(new Position(2, 3), Mark.CROSS),
                new Move(new Position(3, 3), Mark.CROSS),
                new Move(new Position(6, 4), Mark.NOUGHT),
                new Move(new Position(6, 5), Mark.NOUGHT)
        );
...
//            g.periodicBoundaryConditionsInUse();
    ...
    public void validator55AllRotations() throws TheWinnerIsException, ResignException, WrongBoardStateException {
        Set<Move> base = Set.of(
                new Move(new Position(6, 0), Mark.NOUGHT),
                new Move(new Position(4, 1), Mark.CROSS),
                new Move(new Position(6, 1), Mark.NOUGHT),
                new Move(new Position(3, 2), Mark.CROSS),
                new Move(new Position(1, 3), Mark.CROSS),
                new Move(new Position(2, 3), Mark.CROSS),
                new Move(new Position(6, 4), Mark.NOUGHT),
                new Move(new Position(6, 5), Mark.NOUGHT)
        );
...
//            g.periodicBoundaryConditionsInUse();
    ...
    public void validatorTooEarlyResign1AllRotations() throws TheWinnerIsException, ResignException, WrongBoardStateException {
        Set<Move> base = Set.of(
                ...
                new Move(new Position(2, 2), Mark.CROSS),
                new Move(new Position(1, 3), Mark.NOUGHT),
                new Move(new Position(3, 3), Mark.CROSS),
                new Move(new Position(4, 4), Mark.CROSS),
                new Move(new Position(5, 5), Mark.CROSS),
                new Move(new Position(1, 7), Mark.NOUGHT)
        );
...
//            g.periodicBoundaryConditionsInUse();
    ...
    public void validatorTooEarlyResign2AllRotations() throws TheWinnerIsException, ResignException, WrongBoardStateException {
        Set<Move> base = Set.of(
                ...
                new Move(new Position(1, 2), Mark.NOUGHT),
                new Move(new Position(2, 2), Mark.CROSS),
                new Move(new Position(3, 2), Mark.NOUGHT),
                new Move(new Position(1, 3), Mark.NOUGHT),
                new Move(new Position(3, 3), Mark.CROSS),
                new Move(new Position(3, 4), Mark.CROSS),
                new Move(new Position(4, 4), Mark.CROSS),
                new Move(new Position(3, 5), Mark.CROSS),
                new Move(new Position(5, 5), Mark.CROSS),
                new Move(new Position(1, 7), Mark.NOUGHT),
...
//            g.periodicBoundaryConditionsInUse();
    ...
    public void validatorTooEarlyResign3AllRotations() throws TheWinnerIsException, ResignException, WrongBoardStateException {
        Set<Move> base = Set.of(
                ...
                new Move(new Position(1, 3), Mark.NOUGHT),
                new Move(new Position(3, 3), Mark.CROSS),
                new Move(new Position(5, 3), Mark.CROSS),
                new Move(new Position(4, 4), Mark.CROSS),
                new Move(new Position(5, 5), Mark.CROSS),
                new Move(new Position(1, 7), Mark.NOUGHT)
        );
